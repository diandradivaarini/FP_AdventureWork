...
<p class="highcharts-description">
    Berikut merupakan grafik untuk menampilkan total pembelian dari 10 vendor teratas pada database Adventure Works.
</p>
                <!-- /.container-fluid -->
    ...
    Highcharts.chart('barchart2', {
        ...
        title: {
            text: 'Total Pembelian per Vendor (Top 10)'
        },
        subtitle: {
        ...
        series: [{
            ...
            data: [
                <?php foreach ($data4 as $vendor): ?>
                    <?= floatval($vendor["totalPembelian"]); ?>,
                <?php endforeach; ?>
            ]
        }]
    });
